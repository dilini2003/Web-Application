...
const Doctors = () => {
  ...
  const applyFilter = () => {
    if (speciality) {
      setFilterDoc(
        doctors.filter((doc) => doc.speciality === speciality && doc.available)
      );
    } else {
    ...
    <div className="doctors">
      ...
      <div className="speciality-section" id="speciality">
        ...
        <div className="specialities">
          <Link className="speciality-card" to="/doctors/General physician">
            <img
          ...
          <Link className="speciality-card" to="/doctors/Gynecologist">
            <img
              className="speciality-img"
          ...
          <Link className="speciality-card" to="/doctors/Dermatologist">
            <img
              className="speciality-img"
          ...
          <Link className="speciality-card" to="/doctors/Pediatricians">
            <img
              className="speciality-img"
          ...
          <Link className="speciality-card" to="/doctors/Neurologist">
            <img
              className="speciality-img"
          ...
          <Link className="speciality-card" to="/doctors/Gastroenterologist">
            <img
              className="speciality-img"
          ...
          <Link className="speciality-card" to="/doctors/ENT Specialist">
            <img
              className="speciality-img"
              src="./images/ENT_specialist.png"
              alt=""
            />
            <p className="specialityname">ENT Specialist</p>
          </Link>
          <Link className="speciality-card" to="/doctors/Psychiatrist">
            <img
              className="speciality-img"
