...
const listAppointments = async (req, res) =>{
    try {
        const userId = req.userId;
        const Appointments = await appointmentModel.find({userId}).sort({ date: -1 }); // latest first
...
export {registerUser, loginUser, getProfile, updateProfile, bookAppointment, listAppointments ,payAppointment, cancelAppointment}